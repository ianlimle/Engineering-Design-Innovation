...
class LettuceDataset(utils.Dataset):
...
if __name__ == "__main__":
    ...
    if args["mode"] == "train":
        ...
        trainDataset = LettuceDataset(IMAGE_PATHS, ANNOT_PATH, CLASS_NAMES)
        trainDataset.load_lettuce(trainIdxs)
        trainDataset.prepare()

		# load the validation dataset
        valDataset = LettuceDataset(IMAGE_PATHS, ANNOT_PATH, CLASS_NAMES)
        valDataset.load_lettuce(valIdxs)
        valDataset.prepare()
